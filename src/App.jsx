...
/* ====== Import dynamique des affiches ======
   Met tes fichiers dans: src/assets/spectacle/affiches/
   Noms acceptés:
     - 2025-12-05_titre.jpg
     - 05-12-2025_titre.png
*/
...
function parseDateFromFilename(fileBase) {
  // YYYY-MM-DD
  let m = fileBase.match(/^(\d{4})[-_.](\d{2})[-_.](\d{2})/);
  if (m) return new Date(`${m[1]}-${m[2]}-${m[3]}`);
  // DD-MM-YYYY
  m = fileBase.match(/^(\d{2})[-_.](\d{2})[-_.](\d{4})/);
...
export default function App() {
  ...
  return (
    <div className="app">
      ...
      {/* SPECTACLES – Hero + Grille d’affiches */}
      <section id="spectacles" className="section section-spectacle-hero">
        <div className="spectacle-hero">
          ...
          <div className="spectacle-hero-content">
            ...
            <button className="main-spectacle-btn" onClick={() => scrollToId("affiches")}>
      ...
      {/* Grille d’affiches */}
      <section id="affiches" className="section posters-page">
